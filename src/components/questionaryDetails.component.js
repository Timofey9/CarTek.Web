                ...
                <div className="col-md-6">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            ...
                            <StateRadioButtonGroup type={"Шпильки"} id={"trailerPinsState2"} isActive={trailerQuestionary.wheelsJsonObject.backAxle.frontAxle.pinsState} option1="В норме" option2="Требуется замена" />
                            <div>
                                <label htmlFor="pressure">Давление:</label>
